...
int main() 
{
    ...
    {
        cout << "----------------------------------------------------------------" << endl;
        cout << "Добро пожаловать в программу шифрования DES !                   |" << endl;
        cout << "Ниже представлено меню, выберите нужную функцию и нажмите Enter.|" << endl;
        cout << "----------------------------------------------------------------" << endl;
